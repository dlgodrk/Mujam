            ...
            <article>
                ...
                <div class="art-content">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <a class="example-image-link" href="${pageContext.request.contextPath}../resources/images/6-zoom.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><div class="zoom-container"><div class="zoom-caption"><i class="fa fa-eye"></i></div><img class="example-image" src="${pageContext.request.contextPath}../resources/images/6.jpg" alt=""/></div></a>
                                <a class="example-image-link" href="${pageContext.request.contextPath}../resources/images/9-zoom.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><div class="zoom-container"><div class="zoom-caption"><i class="fa fa-eye"></i></div><img class="example-image" src="${pageContext.request.contextPath}../resources/images/9.jpg" alt=""/></div></a>
                                <a class="example-image-link" href="${pageContext.request.contextPath}../resources/images/6-zoom.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><div class="zoom-container"><div class="zoom-caption"><i class="fa fa-eye"></i></div><img class="example-image" src="${pageContext.request.contextPath}../resources/images/6.jpg" alt=""/></div></a>
                                <a class="example-image-link" href="${pageContext.request.contextPath}../resources/images/10-zoom.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><div class="zoom-container"><div class="zoom-caption"><i class="fa fa-eye"></i></div><img class="example-image" src="${pageContext.request.contextPath}../resources/images/10.jpg" alt=""/></div></a>
                                <a class="example-image-link" href="${pageContext.request.contextPath}../resources/images/7-zoom.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><div class="zoom-container"><div class="zoom-caption"><i class="fa fa-eye"></i></div><img class="example-image" src="${pageContext.request.contextPath}../resources/images/7.jpg" alt=""/></div></a>
                                <a class="example-image-link" href="${pageContext.request.contextPath}../resources/images/8-zoom.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><div class="zoom-container"><div class="zoom-caption"><i class="fa fa-eye"></i></div><img class="example-image" src="${pageContext.request.contextPath}../resources/images/8.jpg" alt=""/></div></a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
